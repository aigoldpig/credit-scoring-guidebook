...
| **부록** | 보충 | A. SHAP과 Functional ANOVA — Non-identifiability, fANOVA 분해, Purification, SHAP vs fANOVA |

### 🏦 여신 프로세스

신용평가모형이 실제 여신 업무에서 어떻게 활용되는지를 정리합니다.

| 단계 | 주제 | 핵심 내용 |
|:----:|------|-----------|
| **①** | 모형 개발 | CSS 개발 프로세스 전체 흐름 |
| **②** | 심사·승인 | 신용평가모형 기반 심사 의사결정 |
| **③** | 사후 관리 | 포트폴리오 모니터링, 조기경보 |
| **④** | 부실·추심 | 부실채권 관리와 추심 전략 |
| **⑤** | 리스크·규제 | 리스크 관리 체계와 규제 요건 |
| **용어** | PD·LGD·EAD | 핵심 리스크 파라미터 정의 |
