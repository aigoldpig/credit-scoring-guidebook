...
SR 11-7의 핵심 원칙(개념적 건전성, 독립적 검증, 거버넌스 등)과 Basel IRB 검증 요건, 국내 금감원 가이드라인 등 **공통 규제 프레임워크**는 스코어카드 섹션의 [규제 프레임워크](../../scorecard/part5_scorecard/regulatory-framework.md)에서 상세히 다루었다. 여기서는 **ML 모형에서 추가로 고려할 사항**에 집중한다.
