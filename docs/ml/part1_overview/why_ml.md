...
!!! info "Depth = 1이면 교호작용이 사라진다"
    Depth = 1인 트리(stump)를 사용하면 각 트리가 변수 하나만 사용하므로 교호작용이 구조적으로 불가능하다. 이 특성에 대해서는 [1-Depth GBM 스코어카드](../part4_interpretation/depth1_gbm.md)에서 다룬다.
...
한국에서 신용평가모형(CSS)은 금융감독원의 **[신용정보업감독규정](https://www.law.go.kr/admRulLsInfoP.do?admRulSeq=2100000239666)**의 적용을 받는다. 핵심 요건은 다음과 같다:
...
| **4. 해석과 설명** | [해석 가능성](../part4_interpretation/interpretability.md) | SHAP, PDP, TreeSHAP |
| | [1-Depth GBM 스코어카드](../part4_interpretation/depth1_gbm.md) | GAM 동치, Shape Function |
| | [EBM (GA²M)](../part4_interpretation/ebm.md) | 2-stage 학습, Purification |
