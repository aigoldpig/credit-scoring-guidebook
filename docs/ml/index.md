...
이 섹션에서는 SHAP을 중심으로 한 해석 기법, Surrogate Model을 통한 규제 대응, 그리고 1-Depth GBM/EBM처럼 **해석 가능성과 성능을 동시에 추구하는 하이브리드 접근**까지 다룬다. 모형을 만드는 것과 **쓸 수 있게 만드는 것**은 다른 문제이며, 후자가 더 어렵다.
